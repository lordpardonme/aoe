...
print("Waiting 30 seconds for Google Sheets write quota window to reset...")
time.sleep(30)
...
for tab in ['Agencies', 'LinkedIn Search', 'Direct Employers']:
    try:
        ...
        if batch_data:
            print(f"[{tab}] Updating {len(batch_data)} rows in 1 single call...")
        ...
        print(f"Error on {tab}: {ex}")

print("\nALL TABS FULLY SYNCHRONIZED!")
