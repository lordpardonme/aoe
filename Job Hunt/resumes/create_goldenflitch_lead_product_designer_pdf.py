...
p("LEAD PRODUCT DESIGNER | PRODUCT UX, SYSTEMS & SCALABLE INTERFACES", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Gurugram opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
story.append(Spacer(1, 3))
p("<b>Lead Product Designer with 6+ years of experience</b> designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in product thinking, user journeys, visual craft, and design-system execution, with a practical focus on simplifying complexity and working closely with product, engineering, and business teams.")
