...
## UI/UX Designer | Web, Mobile and Design Systems

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to remote, hybrid, or on-site opportunities

## Professional Summary

UI/UX and Product Designer with 6+ years of experience designing responsive web products, mobile apps, B2B platforms, internal tools, and reusable design systems. Strong in turning real client and product requirements into user flows, wireframes, prototypes, high-fidelity UI, and developer-ready handoff. I bring proven work across healthcare, logistics, fintech-adjacent products, marketplaces, and brand-led digital projects, along with a portfolio of shipped and client-facing work.

## Core Skills

**UI/UX:** User flows, information architecture, wireframing, interaction design, responsive web and mobile UI, prototyping, usability testing, design thinking, stakeholder communication
...
**Visual and Digital Product Work:** Website mockups, landing pages, dashboards, content-led UI, brand-led digital experiences, design polishing, layout systems, typography, visual hierarchy
