...
## Senior UI/UX Engineer | Design Systems, Front-End Aware UX & AI Workflows

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to Hyderabad hybrid / relocation discussion | Immediate / short-notice discussion

## Professional Summary

UI/UX and Product Designer with 6+ years of experience designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in turning ambiguous requirements into user flows, wireframes, prototypes, high-fidelity UI, and design-system documentation. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with a practical focus on visual consistency, usability, responsive behavior, and close collaboration with product and engineering teams.

## Core Skills

**UX and Product Design:** User flows, information architecture, wireframing, interaction design, responsive desktop and mobile UI, prototyping, usability testing, design thinking, stakeholder communication

**Systems and Delivery:** Figma, FigJam, Auto Layout, reusable components, design systems, design QA, developer handoff, client revisions, cross-functional collaboration, responsive specifications

**Front-End Aware Design:** HTML/CSS collaboration, component specs, layout consistency, spacing and typography audits, implementation review, accessibility-aware UI, production handoff, design accuracy in browser

**Visual Product Work:** Website mockups, dashboard UI, content-heavy interfaces, brand-aligned UI, layout systems, typography, visual hierarchy, UI cleanup and standardization
...
- Uncover / Meddo: healthcare product UX and design system work. https://uncover.co.in/
- FuelBuddy: customer, business, and operational product design across web and mobile. https://app.fuelbuddy.in/
- Kama Capital: multi-asset trading website and onboarding journeys. https://kama-capital.com/
- TS Logix Peru: logistics and warehousing web and internal tooling. https://tslogixperu.com/
