...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_UX_Designer_ConsultantPartners.pdf")
...
p("UX DESIGNER | FIGMA, DESIGN SYSTEMS, AND PRODUCT UI", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to remote, hybrid, or contract opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
story.append(Spacer(1, 3))
p("<b>UX/UI and Product Designer with 6+ years of experience</b> designing responsive web and mobile products, scalable Figma systems, and high-volume interface workflows. Strong in turning ambiguous requirements into user flows, wireframes, prototypes, high-fidelity UI, and implementation-ready handoff. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with a consistent focus on clean interaction design and practical collaboration.")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - UX Designer - Consultant Partners",
).build(story)
