...
## Product Designer | UI Craft, Design Systems & UX Fundamentals

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to Noida hybrid opportunities

## Professional Summary

Product Designer with 6+ years of experience designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in UI craft, user journeys, information architecture, and design-system thinking, with a practical focus on layouts, typography, visual hierarchy, interaction design, and collaboration with product and engineering teams. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, and I use AI-assisted workflows to improve exploration, speed, and problem solving.

## Core Skills

**UX and Product Design:** User journeys, information architecture, wireframing, interaction design, responsive desktop and mobile UI, prototyping, usability testing, design thinking, stakeholder communication

**Systems and Delivery:** Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, client revisions, cross-functional collaboration

**Visual Product Work:** Layout systems, typography, visual hierarchy, spacing, color, responsive composition, website mockups, dashboard UI, content-heavy interfaces, UI cleanup and standardization

**AI-Assisted Workflow:** AI design tools, concept exploration, iteration speed, prompt-assisted ideation, production support, design problem solving
