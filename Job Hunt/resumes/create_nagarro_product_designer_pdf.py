...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Product_Designer_Nagarro.pdf")
...
p("PRODUCT DESIGNER | ENTERPRISE DESIGN SYSTEMS, MOBILE & WEB UX", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Dubai onsite opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
story.append(Spacer(1, 3))
p("<b>Product Designer with 6+ years of experience</b> designing responsive web, desktop, and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in enterprise-style design systems, cross-platform product UX, and translating complex business requirements into clear product experiences. Comfortable working in agile product squads with product, engineering, and business stakeholders.")

sec("Core Skills")
p("<b>Product and UX Design:</b> User journeys, information architecture, wireframing, interaction design, responsive desktop and mobile UI, prototyping, usability testing, design thinking, stakeholder communication")
p("<b>Enterprise Systems and Delivery:</b> Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration, responsive specifications")
p("<b>Mobile and Web Product Work:</b> iOS and Android app design, web and desktop interfaces, layout systems, typography, visual hierarchy, complex workflow simplification, dashboard UI")
p("<b>Product Collaboration:</b> Agile squad collaboration, requirement shaping, iteration, release decision support, design reviews, implementation follow-through")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Product Designer - Nagarro"
).build(story)
print(OUT)
