...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Sr_Product_Designer_OneThing.pdf")
...
p("SR. PRODUCT DESIGNER | PRODUCT UX, SYSTEMS & SCALABLE INTERFACES", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Gurgaon opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
story.append(Spacer(1, 3))
p("<b>Senior Product Designer with 6+ years of experience</b> designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in product thinking, user journeys, visual craft, and design-system execution, with a practical focus on simplifying complexity and working closely with product, engineering, and business teams.")
...
p("<b>Systems and Delivery:</b> Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration, responsive specifications")
p("<b>Visual Product Work:</b> Layout systems, typography, visual hierarchy, spacing, color, responsive composition, dashboard UI, content-heavy interfaces, UI cleanup and standardization")
p("<b>Product Collaboration:</b> Founder collaboration, requirement shaping, iteration, release decision support, design reviews, implementation follow-through")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Sr Product Designer - OneThing"
).build(story)
print(OUT)
