...
## Senior UX Designer | Product UX, Systems & Responsive Interfaces

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to remote opportunities

## Professional Summary

Senior UX/UI and Product Designer with 6+ years of experience shaping responsive web and mobile products, reusable design systems, and implementation-ready interfaces. Strong in user flows, wireframes, high-fidelity UI, usability reviews, and working closely with product and engineering teams to ship polished experiences. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with a consistent focus on clarity, craft, usability, and measurable product impact.
