...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_UX_Designer_Cognizant_Native_Mobile.pdf")
...
p("UX DESIGNER | NATIVE MOBILE APPS, DESIGN SYSTEMS & PRODUCT UX", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Hyderabad opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
story.append(Spacer(1, 3))
p("<b>UX/UI and Product Designer with 6+ years of experience</b> designing native mobile app experiences, responsive digital products, and scalable design systems. Strong in user flows, wireframes, prototyping, mobile interaction patterns, and translating business requirements into polished, implementation-ready interfaces.")

sec("Core Skills")
p("<b>Mobile UX and Product Design:</b> Native mobile app design, user journeys, information architecture, wireframing, interaction design, mobile interaction patterns, prototyping, usability testing")
p("<b>Systems and Delivery:</b> Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration")
p("<b>Visual and Interface Design:</b> Typography, spacing, color, visual hierarchy, layout systems, accessibility-aware UI, high-fidelity design, responsive specifications")
p("<b>Product Process:</b> UX strategy, design process, stakeholder communication, requirement shaping, iteration, release support")
...
bullet("FuelBuddy customer and operations product design across web and mobile. https://app.fuelbuddy.in/")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - UX Designer - Cognizant Native Mobile"
).build(story)
print(OUT)
