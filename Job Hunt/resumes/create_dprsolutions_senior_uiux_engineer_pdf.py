...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Senior_UI_UX_Engineer_DPR_Solutions.pdf")
...
p("SENIOR UI/UX ENGINEER | DESIGN SYSTEMS, FRONT-END AWARE UX & AI WORKFLOWS", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Hyderabad hybrid / relocation discussion | Immediate / short-notice discussion", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
p("<b>UI/UX and Product Designer with 6+ years of experience</b> designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in turning ambiguous requirements into user flows, wireframes, prototypes, high-fidelity UI, and design-system documentation. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with a practical focus on visual consistency, usability, responsive behavior, and close collaboration with product and engineering teams.")
...
p("<b>Systems and Delivery:</b> Figma, FigJam, Auto Layout, reusable components, design systems, design QA, developer handoff, client revisions, cross-functional collaboration, responsive specifications")
p("<b>Front-End Aware Design:</b> HTML/CSS collaboration, component specs, layout consistency, spacing and typography audits, implementation review, accessibility-aware UI, production handoff, design accuracy in browser")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Senior UI UX Engineer - DPR Solutions"
).build(story)
print(OUT)
