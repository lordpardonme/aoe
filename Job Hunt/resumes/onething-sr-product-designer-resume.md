...
## Sr. Product Designer | Product UX, Systems & Scalable Interfaces

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to Gurgaon opportunities

## Professional Summary

Senior Product Designer with 6+ years of experience designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in product thinking, user journeys, visual craft, and design-system execution, with a practical focus on simplifying complexity and working closely with product, engineering, and business teams. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with measurable improvements in completion, reliability, and usability.
...
**Systems and Delivery:** Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration, responsive specifications

**Visual Product Work:** Layout systems, typography, visual hierarchy, spacing, color, responsive composition, dashboard UI, content-heavy interfaces, UI cleanup and standardization

**Product Collaboration:** Founder collaboration, requirement shaping, iteration, release decision support, design reviews, implementation follow-through
