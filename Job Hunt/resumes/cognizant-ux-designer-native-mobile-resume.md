...
## UX Designer | Native Mobile Apps, Design Systems & Product UX

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to Hyderabad opportunities

## Professional Summary

UX/UI and Product Designer with 6+ years of experience designing native mobile app experiences, responsive digital products, and scalable design systems. Strong in user flows, wireframes, prototyping, mobile interaction patterns, and translating business requirements into polished, implementation-ready interfaces. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, with measurable improvements in usability, completion, and product consistency.

## Core Skills

**Mobile UX and Product Design:** Native mobile app design, user journeys, information architecture, wireframing, interaction design, mobile interaction patterns, prototyping, usability testing

**Systems and Delivery:** Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration

**Visual and Interface Design:** Typography, spacing, color, visual hierarchy, layout systems, accessibility-aware UI, high-fidelity design, responsive specifications

**Product Process:** UX strategy, design process, stakeholder communication, requirement shaping, iteration, release support
...
- FuelBuddy customer and operations product design across web and mobile. https://app.fuelbuddy.in/
