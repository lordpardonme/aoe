...
def build_cover_letter(out_path):
    ...
    story = [
        ...
        Paragraph("I am writing to formally apply for the <b>Post-Production Lead</b> position at Bling Ping in Mumbai. With 5+ years of commercial post-production experience spanning commercial campaigns, music videos, and multi-stream digital content, I specialize in building disciplined editing workflows, enforcing rigorous quality control, and ensuring fast turnaround on high-volume deliverables.", S["body"]),
