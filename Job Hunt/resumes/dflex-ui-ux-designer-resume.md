...
## UI/UX Designer | Commerce Journeys, Ordering & Design Systems

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to remote, hybrid, or relocation discussion

## Professional Summary

UI/UX and Product Designer with 6+ years of experience designing connected customer journeys, operational platforms, responsive web and mobile products, and scalable design systems. Strong record of partnering with product managers, engineers, founders, and stakeholders to simplify complex workflows, improve completion, and translate business requirements into intuitive product experiences. Experienced in user research, interaction design, high-fidelity UI, design systems, and working through detailed service and commerce flows with measurable outcomes.

## Core Capabilities

**Product Strategy & UX:** Product thinking, UX strategy, user research, journey mapping, information architecture, user flows, service design, prototyping, usability testing, experimentation, product metrics

**Commerce & Operations:** Ordering, payment and wallet UX, account controls, delegated access, fulfillment workflows, internal operations, dashboards, support systems, trust and error states, service flow simplification

**UI & Delivery:** High-fidelity UI, responsive design, design systems, reusable Figma components, accessibility awareness, developer handoff, design QA, stakeholder management, cross-functional collaboration
...
- TS Logix Peru: logistics website and internal WMS work covering inventory and operational workflows. https://tslogixperu.com/
- Vgen23: complex genetic interpretation and reporting application. https://vgen23.com/
- Portfolio: product, UX/UI, systems, and visual work. https://workofhayaat.framer.website

## Tools

Figma, FigJam, Framer, Adobe Photoshop, Illustrator, After Effects, Rive, Miro, Adobe XD, Google Analytics, Hotjar
