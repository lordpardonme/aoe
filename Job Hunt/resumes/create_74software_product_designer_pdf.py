...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Product_Designer_74Software.pdf")
...
p("PRODUCT DESIGNER | UI CRAFT, DESIGN SYSTEMS & UX FUNDAMENTALS", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to Noida hybrid opportunities", "contact")
p("Portfolio: https://workofhayaat.framer.website", "contact")
p("<b>Product Designer with 6+ years of experience</b> designing responsive web and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in UI craft, user journeys, information architecture, and design-system thinking, with a practical focus on layouts, typography, visual hierarchy, interaction design, and collaboration with product and engineering teams. I have delivered work across healthcare, logistics, fintech-adjacent products, marketplaces, and internal tools, and I use AI-assisted workflows to improve exploration, speed, and problem solving.")

sec("Core Skills")
p("<b>UX and Product Design:</b> User journeys, information architecture, wireframing, interaction design, responsive desktop and mobile UI, prototyping, usability testing, design thinking, stakeholder communication")
...
p("<b>Visual Product Work:</b> Layout systems, typography, visual hierarchy, spacing, color, responsive composition, website mockups, dashboard UI, content-heavy interfaces, UI cleanup and standardization")
p("<b>AI-Assisted Workflow:</b> AI design tools, concept exploration, iteration speed, prompt-assisted ideation, production support, design problem solving")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Product Designer - 74Software"
).build(story)
print(OUT)
