...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Product_Designer_UI_UX_Seventh_Contact.pdf")
...
p("PRODUCT DESIGNER (UI/UX) | ENTERPRISE APPLICATIONS, WEB/MOBILE & DESIGN SYSTEMS", "title")
...
p("<b>Product Designer (UI/UX) with 6+ years of experience</b> designing intuitive, user-centered digital products, enterprise-style workflows, responsive web/mobile interfaces, dashboards, internal tools, and scalable Figma design systems. Strong in solving complex user problems, turning business and user requirements into flows and prototypes, and collaborating with product, engineering, marketing, founders, and stakeholders to ship usable digital experiences. Experienced across logistics, healthcare, fintech-adjacent products, education/learning, B2B platforms, operational systems, customer apps, and data-heavy workflows.")

sec("Core Skills")
p("<b>Product and UX:</b> User research, journey mapping, information architecture, user flows, wireframes, interaction design, prototypes, usability testing, product iteration, stakeholder feedback")
p("<b>Enterprise and Web/Mobile UI:</b> Enterprise applications, B2B portals, dashboards, internal tools, operational workflows, account controls, analytics surfaces, responsive web, iOS/Android product patterns")
p("<b>Visual and Interaction Design:</b> High-fidelity UI, typography, layout, color, spacing, visual hierarchy, micro-interaction thinking, motion direction, accessible interface patterns")
p("<b>Systems and Delivery:</b> Figma, FigJam, Auto Layout, components, variants, design systems, UI states, developer handoff, design QA, HTML/CSS collaboration basics")
...
bullet("FuelBuddy UAE: Fuel-tech product and operational ecosystem across UAE-facing work. https://fuelbuddy.ae/")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Product Designer UI UX - Seventh Contact",
).build(story)
print(OUT)
