...
## Product Designer | Enterprise Design Systems, Mobile & Web UX

mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India  
Portfolio: https://workofhayaat.framer.website | Open to Dubai onsite opportunities

## Professional Summary

Product Designer with 6+ years of experience designing responsive web, desktop, and mobile products, scalable Figma systems, and implementation-ready interfaces. Strong in enterprise-style design systems, cross-platform product UX, and translating complex business requirements into clear product experiences. I have delivered work across fintech-adjacent products, healthcare, logistics, marketplaces, and internal tools, with measurable improvements in completion, reliability, and operational usability. Comfortable working in agile product squads with product, engineering, and business stakeholders.

## Core Skills

**Product and UX Design:** User journeys, information architecture, wireframing, interaction design, responsive desktop and mobile UI, prototyping, usability testing, design thinking, stakeholder communication

**Enterprise Systems and Delivery:** Figma, FigJam, Auto Layout, reusable components, variants, design systems, design QA, developer handoff, cross-functional collaboration, responsive specifications

**Mobile and Web Product Work:** iOS and Android app design, web and desktop interfaces, layout systems, typography, visual hierarchy, complex workflow simplification, dashboard UI

**Product Collaboration:** Agile squad collaboration, requirement shaping, iteration, release decision support, design reviews, implementation follow-through
