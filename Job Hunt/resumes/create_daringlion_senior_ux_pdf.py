...
OUT = Path(__file__).with_name("Mohd_Hayaat_Ali_Senior_UX_Designer_DaringLionTech.pdf")
...
p("SENIOR UX DESIGNER | PRODUCT UX, SYSTEMS & RESPONSIVE INTERFACES", "title")
p("mohdhayaat1@outlook.com | +91-7905194153 | Delhi NCR, India | Open to remote opportunities", "contact")
...
SimpleDocTemplate(
    ...
    title="Mohd Hayaat Ali - Senior UX Designer - DaringLionTech"
).build(story)
print(OUT)
